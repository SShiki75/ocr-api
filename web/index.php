...
<head>
    ...
    <title>レシートOCR - 直接API版</title>
    <link rel="stylesheet" href="style.css">
</head>
<body>
    <div class="container">
        <header>
            <h1>🧾 ファミリーマート レシートOCR（直接API版）</h1>
            <p>ブラウザから直接APIに接続（infinityfree制限を回避）</p>
        </header>
        ...
        <footer>
            ...
            <p style="font-size: 0.9em; margin-top: 5px;">
                ブラウザから直接 <code>ocr-api-wh2v.onrender.com</code> に接続
            </p>
        </footer>
    </div>
    ...
    <script>
            ...
            if (data.total) {
                html += `
                    <tr class="total-row">
                        ...
                        <td class="price"><strong>¥${data.total.toLocaleString()}</strong></td>
                    </tr>
                `;
            }
        ...
        function downloadCSV() {
            ...
            if (window.currentResult.total) {
                csv += `"合計",${window.currentResult.total}\n`;
            }
